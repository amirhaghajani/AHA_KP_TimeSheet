...
/****** Object:  Database [RASTimeSheets]    Script Date: 9/16/2019 6:58:56 AM ******/
CREATE DATABASE [RASTimeSheets]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'RASTimeSheets', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.SEPAROKDB\MSSQL\DATA\RASTimeSheets.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'RASTimeSheets_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.SEPAROKDB\MSSQL\DATA\RASTimeSheets_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [RASTimeSheets] SET COMPATIBILITY_LEVEL = 130
GO
...
ALTER DATABASE [RASTimeSheets] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [RASTimeSheets] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [RASTimeSheets] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [RASTimeSheets] SET QUERY_STORE = OFF
GO
